...
class IpAddressModelTest < ActiveSupport::TestCase
  ...
  test "IpAddress creation: min success" do
    BarclampNetwork::IpAddress.create!( :cidr => "0.0.0.0/0" )
  end


  # Test successful creation, max
  test "IpAddress creation: max success" do
    BarclampNetwork::IpAddress.create!( :cidr => "255.255.255.255/32" )
  end


  # Test successful creation, normal
  test "IpAddress creation: success" do
    BarclampNetwork::IpAddress.create!( :cidr => "192.168.132.124/32" )
  end
  ...
  test "IpAddress creation: alpha failure" do
    assert_raise( ActiveRecord::RecordInvalid ) do
      BarclampNetwork::IpAddress.create!( :cidr => "192.blah.130.124/24" )
    end
  end
  ...
  test "IpAddress creation: 1st octet overflow failure" do
    assert_raise( ActiveRecord::RecordInvalid ) do
      BarclampNetwork::IpAddress.create!( :cidr => "256.168.130.124/24" )
    end
  end
  ...
  test "IpAddress creation: 2nd octet overflow failure" do
    assert_raise( ActiveRecord::RecordInvalid ) do
      BarclampNetwork::IpAddress.create!( :cidr => "192.256.130.124/24" )
    end
  end
  ...
  test "IpAddress creation: 3rd octet overflow failure" do
    assert_raise( ActiveRecord::RecordInvalid ) do
      BarclampNetwork::IpAddress.create!( :cidr => "192.168.256.124/24" )
    end
  end
  ...
  test "IpAddress creation: 4th octet overflow failure" do
    assert_raise( ActiveRecord::RecordInvalid ) do
      BarclampNetwork::IpAddress.create!( :cidr => "192.168.130.256/24" )
    end
  end
  ...
  test "IpAddress creation: cidr overflow failure" do
    assert_raise( ActiveRecord::RecordInvalid ) do
      BarclampNetwork::IpAddress.create!( :cidr => "192.168.130.256/33" )
    end
  end
  ...
  test "IpAddress netmask retrieval: failure" do
    ip = BarclampNetwork::IpAddress.create!( :cidr => "192.168.130.10" )
